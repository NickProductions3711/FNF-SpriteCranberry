...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		switch (curStage)
		{
			...
			case 'dude': //TheGuy
				defaultCamZoom = 1.2;
				var bg:BGSprite = new BGSprite('mod/Sky', -269.8, -80.2, 0.6, 0.6);
				bg.updateHitbox();
				add(bg);

				var bg2:BGSprite = new BGSprite('mod/CoolBG', -272, -115.75, 1, 1);
				bg2.updateHitbox();
				add(bg2);

				dudeDoor = new BGSprite('mod/door', -202.1, -240.15, ['doorClosed', 'doorOpen']);
				dudeDoor.animation.play('doorClosed');
				add(dudeDoor);
		...
		if(curStage == 'dude')
		{
			var tree:BGSprite = new BGSprite('mod/Cooltree', 1420.6, -209.65, 1.2, 1.2);
			tree.updateHitbox();
			add(tree);
		}
	...
	override public function update(elapsed:Float)
	{
		...
		if(curStage == 'dude')
		{
			...
			dad.setPosition(410, 69.25);
			gf.setPosition(1020, 0);
		}
...
switch (swagCounter)
		...
		if(curStep == 160)
		{
			...
			dudeDoor.animation.play('doorOpen');
		}
